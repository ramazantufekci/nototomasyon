	...
	<div class="col-sm-12 my-auto">
		...
		<form class="card card-block w-50 h-100 m-auto p-2 bg-light mt-3" action="giris.php" method="POST">
			<div class="mb-3">
			  ...
			  <input type="email" name="email" class="form-control" id="email" placeholder="mail@adresiniz.com"/> 
			</div>
			<div class="mb-3">
			  <label for="password" class="form-label">Şifreniz</label>
			  <input type="password" name="password" class="form-control" id="password" placeholder="Şifre Giriniz"/> 
			</div>
